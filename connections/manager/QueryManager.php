...
class QueryManager
{
    ...
    public static function getSelectedColumnById($table,$data,$where,$id,$Conn=null)
    {
        self::$id    = $id;
        self::$data = $data;
        self::$table = $table;
        ...
        try{
            self::$dbc = self::$Conn;
            self::$sql = "SELECT ".self::$fields." FROM ".self::$table." WHERE $where = ?;";
            self::$response = self::$dbc->prepare(self::$sql, [\PDO::ATTR_CURSOR => \PDO::CURSOR_SCROLL]);
            self::$response->execute([self::$id]);
    ...
    public static function delete($table,$where,$id,$Conn=null)
    {
        self::$id    = $id;
        self::$table = $table;
        self::$Conn  = $Conn;
        ...
        try{
            self::$dbc = self::$Conn;
            self::$sql = "DELETE FROM ".self::$table." WHERE $where = ?;";
            self::$response = self::$dbc->prepare(self::$sql);
            self::$response->execute([self::$id]);
